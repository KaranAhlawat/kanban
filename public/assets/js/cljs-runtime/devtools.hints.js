...
var map__15546 = top_item;
var map__15546__$1 = cljs.core.__destructure_map(map__15546);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15546__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15546__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15546__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e15545){var _e = e15545;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___15600 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___15600)){
var seen_errors_15604 = temp__5802__auto___15600;
if(cljs.core.truth_(seen_errors_15604.has(self))){
} else {
seen_errors_15604.add(self);

var temp__5804__auto___15611 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___15611)){
var sense_15612 = temp__5804__auto___15611;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_15612)].join(''));
} else {
}
}
} else {
