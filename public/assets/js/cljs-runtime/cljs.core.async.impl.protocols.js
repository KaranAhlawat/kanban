...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_12178 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_12178(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_12184 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_12184(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_12187 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_12187(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_12190 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_12190(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_12193 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_12193(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_12198 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_12198(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_12200 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_12200(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_12222 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_12222(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_12225 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_12225(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_12226 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_12226(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_12229 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_12229(b);
}
});
