...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14543 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14543(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_14544 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_14544(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_14545 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_14545(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_14546 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_14546(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14566 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14566(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14567 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14567(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__14541,callback){
var map__14542 = p__14541;
var map__14542__$1 = cljs.core.__destructure_map(map__14542);
var input = map__14542__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14542__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14542__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
