...
var o15427 = temp__5802__auto__;
var temp__5802__auto____$1 = (o15427["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o15428 = temp__5802__auto____$1;
return (o15428["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15080__auto__ = f;
return (o__15080__auto__["toString"]).call(o__15080__auto__);
} else {
return "";
}
}catch (e15436){var _ = e15436;
return "";
}});
...
try{var o__15080__auto___15745 = t;
(o__15080__auto___15745["cljs$lang$ctorPrWriter"]).call(o__15080__auto___15745,t,writer);
}catch (e15447){var __15746 = e15447;
}
...
var char_code = (function (){var o__15080__auto__ = (new String(char$));
return (o__15080__auto__["charCodeAt"]).call(o__15080__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15080__auto__ = String;
return (o__15080__auto__["fromCharCode"]).call(o__15080__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15456 = num_code;
switch (G__15456) {
case (1):
return (185);
...
var o__15080__auto__ = String;
return (o__15080__auto__["fromCharCode"]).call(o__15080__auto__,superscript_code);
});
/**
...
}catch (e15471){var _e__15110__auto__ = e15471;
return false;
}})())){
...
var vec__15477 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15477,(0),null);
...
var len__5769__auto___15752 = arguments.length;
var i__5770__auto___15753 = (0);
while(true){
if((i__5770__auto___15753 < len__5769__auto___15752)){
args__5775__auto__.push((arguments[i__5770__auto___15753]));

var G__15754 = (i__5770__auto___15753 + (1));
i__5770__auto___15753 = G__15754;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15503){
var vec__15504 = p__15503;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15504,(0),null);
...
var G__15757 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__15758 = cljs.core.butlast(remaining_tokens);
name_tokens = G__15757;
remaining_tokens = G__15758;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15498){
var G__15499 = cljs.core.first(seq15498);
var seq15498__$1 = cljs.core.next(seq15498);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15499,seq15498__$1);
}));
...
var vec__15512 = cljs.core.split_with((function (p1__15511_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__15511_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15512,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15512,(1),null);
...
var vec__15525 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15525,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15525,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__15760 = cljs.core.rest(remaining_tokens);
var G__15761 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__15760;
name_tokens = G__15761;
continue;
} else {
...
var vec__15536 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15536,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15536,(1),null);
var vec__15539 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15539,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15539,(1),null);
var vec__15542 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15542,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15542,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15542,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15542,(3),null);
...
var vec__15555 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15555,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15555,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15555,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15555,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15555,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15555,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__15561 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15561,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15561,(1),null);
var vec__15601 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15601,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15601,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__15620 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__15620) : devtools.munging.parse_fn_info_deep.call(null,G__15620));
})()));
}
} else {
return fn_info;
...
var G__15767 = (arity + (1));
var G__15768 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15645){
var vec__15646 = p__15645;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15646,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15646,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15657_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__15657_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15658_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__15658_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15664){
var vec__15665 = p__15664;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15665,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15662){
var G__15663 = cljs.core.first(seq15662);
var seq15662__$1 = cljs.core.next(seq15662);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15663,seq15662__$1);
}));
...
var G__15672 = arg;
var G__15672__$1 = (((G__15672 instanceof cljs.core.Keyword))?G__15672.fqn:null);
switch (G__15672__$1) {
...
var map__15684 = options;
var map__15684__$1 = cljs.core.__destructure_map(map__15684);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15684__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15684__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15684__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15684__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15685 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15685,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15685,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15685,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15685,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15685,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15685,(5),null);
...
var o__15080__auto__ = f;
return (o__15080__auto__["getBasis"]).call(o__15080__auto__);
});
/**
...
}catch (e15704){var _e__15110__auto__ = e15704;
...
var G__15775 = (obj[cljs.core.first(path)]);
var G__15776 = cljs.core.rest(path);
obj = G__15775;
path = G__15776;
continue;
} else {
...
var _STAR_ = (function (accum,p__15732){
var vec__15733 = p__15732;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15733,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15733,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15736){
var vec__15737 = p__15736;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15737,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15737,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15737,(2),null);
...
var post_process = (function (p__15741){
var vec__15742 = p__15741;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15742,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15742,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15740_SHARP_){
return (obj[cljs.core.first(p1__15740_SHARP_)]);
}),sorted_matches);
