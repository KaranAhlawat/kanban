...
var len__5769__auto___15823 = arguments.length;
var i__5770__auto___15824 = (0);
while(true){
if((i__5770__auto___15824 < len__5769__auto___15823)){
args__5775__auto__.push((arguments[i__5770__auto___15824]));

var G__15825 = (i__5770__auto___15824 + (1));
i__5770__auto___15824 = G__15825;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq15779){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15780,G__15781,seq15779__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__15792_SHARP_){
return (!((cljs.core.meta(p1__15792_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15800__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e15803){var _e__15110__auto__ = e15803;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e15805){var _e__15110__auto__ = e15805;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__15808 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__15809 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__15809);
...
var map__15813 = opts;
var map__15813__$1 = cljs.core.__destructure_map(map__15813);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15813__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__15808);
}});
...
var temp__5802__auto___15835 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___15835)){
var managed_print_level_15836 = temp__5802__auto___15835;
var _STAR_print_level_STAR__orig_val__15817_15837 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__15818_15838 = managed_print_level_15836;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__15818_15838);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__15816_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__15816_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__15817_15837);
}} else {
job_fn();
}
