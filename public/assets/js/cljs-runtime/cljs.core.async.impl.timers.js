...
var i_14360 = (0);
while(true){
if((i_14360 < arr.length)){
(arr[i_14360] = null);

var G__14361 = (i_14360 + (1));
i_14360 = G__14361;
continue;
} else {
}
...
var i_14370 = (self__.level + (1));
while(true){
if((i_14370 <= (new_level + (1)))){
(update[i_14370] = self__.header);

var G__14373 = (i_14370 + (1));
i_14370 = G__14373;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14375 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14375[i]));
} else {
x__$2.forward.push((((i < links_14375.length))?(links_14375[i]):null));
}

if((i < links_14375.length)){
(links_14375[i] = x__$2);
} else {
links_14375.push(x__$2);
}
...
var i_14378 = (0);
while(true){
if((i_14378 <= self__.level)){
var links_14380 = (update[i_14378]).forward;
if((x__$1 === (((i_14378 < links_14380.length))?(links_14380[i_14378]):null))){
(links_14380[i_14378] = (x__$1.forward[i_14378]));

var G__14381 = (i_14378 + (1));
i_14378 = G__14381;
continue;
} else {
var G__14382 = (i_14378 + (1));
i_14378 = G__14382;
continue;
}
} else {
...
var G__14384 = nx;
var G__14385 = (level__$1 - (1));
x = G__14384;
level__$1 = G__14385;
continue;
} else {
var G__14386 = x;
var G__14387 = (level__$1 - (1));
x = G__14386;
level__$1 = G__14387;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__14389 = nx;
var G__14390 = (level__$1 - (1));
x = G__14389;
level__$1 = G__14390;
continue;
} else {
var G__14391 = x;
var G__14392 = (level__$1 - (1));
x = G__14391;
level__$1 = G__14392;
continue;
}
